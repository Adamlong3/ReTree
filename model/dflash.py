...
class DFlashDraftModel(Qwen3PreTrainedModel):
    ...
    def __init__(self, config) -> None:
        ...
        self.target_layer_ids = getattr(config, "fusion_target_layers", None)
        if self.target_layer_ids is None:
            dflash_cfg = getattr(config, "dflash_config", {})
            self.target_layer_ids = dflash_cfg.get("target_layer_ids", build_target_layer_ids(config.num_target_layers, config.num_hidden_layers))
